...
const ProductDetails = () => {
    return (
        <div className="relative w-full ">
            <img src="/image/Detail.png" alt="" className='w-full' />
            <div className="absolute top-60 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                <h1 className="font-routhem text-6xl text-[#F903AA] shadow-md">Product Details</h1>
            </div>
            <div>
                <h2 className="absolute font-normal text-5xl text-white mt-[98px] left-1/2 transform -translate-x-1/2">
                    HEADPHONE-128K
                </h2>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6 mt-[300px] w-[1138px] h-[436px] ml-[28%]">
                <div className="flex">
                    <div className="">
                        <img src="/image/headphone1.png" alt="Headphones" className="w-[377px] h-[375px]" />
                    </div>
            ...
            <div className='flex mt-[118px] ml-[49%] gap-[39px] font-semibol text-white'>
